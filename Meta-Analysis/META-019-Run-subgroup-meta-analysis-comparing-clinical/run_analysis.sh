...
print("Starting analysis for META-019")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run subgroup meta-analysis comparing clinical vs healthy populations
# - Context: Test if brain activation differs between patient and control groups across studies
# - Data: 
# - Expected evidence: subgroup_difference.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: META-019")
print(f"  - User Prompt: Run subgroup meta-analysis comparing clinical vs healthy populations")
print(f"  - Context: Test if brain activation differs between patient and control groups across studies")
print(f"  - Data Key: ")
print(f"  - Evidence Required: subgroup_difference.nii.gz, subgroup_table.csv")
