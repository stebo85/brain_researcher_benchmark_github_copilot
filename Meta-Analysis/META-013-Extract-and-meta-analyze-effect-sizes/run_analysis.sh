...
print("Starting analysis for META-013")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Extract and meta-analyze effect sizes from memory fMRI papers
# - Context: Pull standardized effect sizes from papers and synthesize with inverse-variance weighting
# - Data: 
# - Expected evidence: forest_plot.png

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: META-013")
print(f"  - User Prompt: Extract and meta-analyze effect sizes from memory fMRI papers")
print(f"  - Context: Pull standardized effect sizes from papers and synthesize with inverse-variance weighting")
print(f"  - Data Key: ")
print(f"  - Evidence Required: forest_plot.png, meta_analysis_table.csv")
