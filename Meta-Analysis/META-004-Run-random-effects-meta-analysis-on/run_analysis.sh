...
print("Starting analysis for META-004")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run random effects meta-analysis on language activation maps
# - Context: Account for between-study variability when combining language task results
# - Data: 
# - Expected evidence: meta_zmap.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: META-004")
print(f"  - User Prompt: Run random effects meta-analysis on language activation maps")
print(f"  - Context: Account for between-study variability when combining language task results")
print(f"  - Data Key: ")
print(f"  - Evidence Required: meta_zmap.nii.gz, forest_plot.png")
