...
print("Starting analysis for META-014: Run multivariate meta-analysis on correlated brain regions")
print("=" * 60)
...
try:
    ...
    print(f"Task: Run multivariate meta-analysis on correlated brain regions")
