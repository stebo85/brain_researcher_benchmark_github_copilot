...
print("Starting analysis for ELEC-012: Perform cluster-based permutation test on sensor-level data")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Perform cluster-based permutation test on sensor-level data")
