...
print("Starting analysis for ELEC-008: Compute event-related spectral perturbation (ERSP) for theta band")
print("=" * 60)
...
try:
    ...
    print(f"Task: Compute event-related spectral perturbation (ERSP) for theta band")
