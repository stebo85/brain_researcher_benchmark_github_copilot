...
print("Starting analysis for PREP-013")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run AFNI 3dDespike to remove extreme outliers from ADHD data
# - Context: Detect and fix sudden intensity spikes caused by scanner artifacts or motion
# - Data: nilearn.datasets.fetch_adhd
# - Expected evidence: despiked_bold.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: PREP-013")
print(f"  - User Prompt: Run AFNI 3dDespike to remove extreme outliers from ADHD data")
...
print(f"  - Evidence Required: despiked_bold.nii.gz, spike_report.txt")
