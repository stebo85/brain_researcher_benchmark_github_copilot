...
print("Starting analysis for PREP-002")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Preprocess ADHD-200 resting-state with ICA-AROMA denoising
...
# - Expected evidence: *_desc-smoothAROMAnonaggr_bold.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: PREP-002")
print(f"  - User Prompt: Preprocess ADHD-200 resting-state with ICA-AROMA denoising")
...
print(f"  - Evidence Required: *_desc-smoothAROMAnonaggr_bold.nii.gz, mixing_matrix.tsv")
