...
print("Starting analysis for PREP-018")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Apply scrubbing to remove high-motion volumes from Development fMRI
...
# - Expected evidence: scrubbed_bold.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: PREP-018")
print(f"  - User Prompt: Apply scrubbing to remove high-motion volumes from Development fMRI")
...
print(f"  - Evidence Required: scrubbed_bold.nii.gz, censoring_mask.txt")
