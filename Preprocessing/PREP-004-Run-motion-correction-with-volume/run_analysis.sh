...
print("Starting analysis for PREP-004")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run motion correction with volume registration on Development fMRI
...
# - Expected evidence: motion_corrected_bold.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: PREP-004")
print(f"  - User Prompt: Run motion correction with volume registration on Development fMRI")
...
print(f"  - Evidence Required: motion_corrected_bold.nii.gz, motion_parameters.txt")
