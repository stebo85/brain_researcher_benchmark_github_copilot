...
print("Starting analysis for PREP-019")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run resampling to 2mm isotropic resolution for HCP MegaTrawls source data
# - Context: Change voxel size to standard resolution for compatibility with analysis tools
# - Data: 
# - Expected evidence: resampled_bold.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: PREP-019")
print(f"  - User Prompt: Run resampling to 2mm isotropic resolution for HCP MegaTrawls source data")
print(f"  - Context: Change voxel size to standard resolution for compatibility with analysis tools")
print(f"  - Data Key: ")
print(f"  - Evidence Required: resampled_bold.nii.gz, transformation_matrix.txt")
