...
print("Starting analysis for SEG-016")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run joint tissue segmentation and bias correction on NKI
...
# - Expected evidence: tissue_probs/

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SEG-016")
print(f"  - User Prompt: Run joint tissue segmentation and bias correction on NKI")
...
print(f"  - Evidence Required: tissue_probs/, bias_corrected.nii.gz")
