...
print("Starting analysis for SEG-007: Run brainstem substructure segmentation on OASIS dataset")
print("=" * 60)
...
try:
    ...
    print(f"Task: Run brainstem substructure segmentation on OASIS dataset")
