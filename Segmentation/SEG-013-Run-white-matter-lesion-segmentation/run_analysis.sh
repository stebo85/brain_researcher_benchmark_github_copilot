...
print("Starting analysis for SEG-013")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run white matter lesion segmentation for aging cohort
...
# - Expected evidence: wml_mask.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SEG-013")
print(f"  - User Prompt: Run white matter lesion segmentation for aging cohort")
...
print(f"  - Evidence Required: wml_mask.nii.gz, lesion_burden.csv")
