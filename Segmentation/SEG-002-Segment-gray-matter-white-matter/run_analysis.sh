...
echo "=========================================="
echo "SEG-002: Segment gray matter, white matter, and CSF from ADHD-200 T1w images"
...
echo ""
echo "Step 4: Running analysis for SEG-002..."
python3 << 'PYEOF'
import os
import sys
...
if [ -f "${EVIDENCE_DIR}/c3_csf.nii.gz" ] || [ -d "${EVIDENCE_DIR}/c3_csf.nii.gz" ]; then
    echo "✓ Found: c3_csf.nii.gz"
else
    echo "⚠ Not found: c3_csf.nii.gz (may need task-specific implementation)"
fi
...
# SEG-002 Evidence: Segment gray matter, white matter, and CSF from ADHD-200 T1w images
