...
print("Starting analysis for SEG-014")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Segment cortical thickness maps from Haxby FreeSurfer outputs
...
# - Expected evidence: lh.thickness

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SEG-014")
print(f"  - User Prompt: Segment cortical thickness maps from Haxby FreeSurfer outputs")
...
print(f"  - Evidence Required: lh.thickness, rh.thickness, thickness_stats.csv")
