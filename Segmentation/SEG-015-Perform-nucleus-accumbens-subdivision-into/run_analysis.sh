...
print("Starting analysis for SEG-015")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Perform nucleus accumbens subdivision into core and shell
# - Context: Separate reward-related striatal structure into functional subregions
# - Data: nilearn.datasets.fetch_abide_pcp
# - Expected evidence: nac_core_shell.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SEG-015")
print(f"  - User Prompt: Perform nucleus accumbens subdivision into core and shell")
...
print(f"  - Evidence Required: nac_core_shell.nii.gz, volumes.csv")
