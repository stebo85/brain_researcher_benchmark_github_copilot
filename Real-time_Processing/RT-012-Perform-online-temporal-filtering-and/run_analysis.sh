...
print("Starting analysis for RT-012: Perform online temporal filtering and physiological noise removal")
print("=" * 60)
...
try:
    ...
    print(f"Task: Perform online temporal filtering and physiological noise removal")
