...
print("Starting analysis for RT-020: Implement online k-space artifact detection and rejection")
print("=" * 60)
...
try:
    ...
    print(f"Task: Implement online k-space artifact detection and rejection")
