...
print("Starting analysis for RT-014")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Implement online brain state classification for closed-loop stimulation
# - Context: Classify vigilance states to trigger intervention at optimal moments
# - Data: 
# - Expected evidence: state_labels.csv

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: RT-014")
print(f"  - User Prompt: Implement online brain state classification for closed-loop stimulation")
print(f"  - Context: Classify vigilance states to trigger intervention at optimal moments")
print(f"  - Data Key: ")
print(f"  - Evidence Required: state_labels.csv, trigger_times.json")
