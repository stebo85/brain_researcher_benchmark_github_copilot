...
print("Starting analysis for RT-002: Implement incremental GLM for online activation detection")
print("=" * 60)
...
try:
    ...
    print(f"Task: Implement incremental GLM for online activation detection")
