...
print("Starting analysis for RT-017")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Implement real-time tensor decomposition for denoising
# - Context: Use multi-echo information to separate BOLD from non-BOLD signals online
# - Data: 
# - Expected evidence: denoised_volumes.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: RT-017")
print(f"  - User Prompt: Implement real-time tensor decomposition for denoising")
print(f"  - Context: Use multi-echo information to separate BOLD from non-BOLD signals online")
print(f"  - Data Key: ")
print(f"  - Evidence Required: denoised_volumes.nii.gz, component_timecourses.csv")
