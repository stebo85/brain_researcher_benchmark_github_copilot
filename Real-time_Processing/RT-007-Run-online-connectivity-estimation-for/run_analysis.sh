...
print("Starting analysis for RT-007")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run online connectivity estimation for neurofeedback
# - Context: Calculate brain region correlations in real-time for connectivity training
# - Data: 
# - Expected evidence: connectivity_timeseries.csv

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: RT-007")
print(f"  - User Prompt: Run online connectivity estimation for neurofeedback")
print(f"  - Context: Calculate brain region correlations in real-time for connectivity training")
print(f"  - Data Key: ")
print(f"  - Evidence Required: connectivity_timeseries.csv, network_evolution.png")
