...
print("Starting analysis for WORK-002: Execute end-to-end connectivity analysis on ABIDE: preprocess, extract time series, compute connectivity, graph metrics")
print("=" * 60)
...
try:
    ...
    print(f"Task: Execute end-to-end connectivity analysis on ABIDE: preprocess, extract time series, compute connectivity, graph metrics")
