...
print("Starting analysis for WORK-018: Run connectivity dynamics workflow: sliding window, state detection, transition analysis")
print("=" * 60)
...
try:
    ...
    print(f"Task: Run connectivity dynamics workflow: sliding window, state detection, transition analysis")
