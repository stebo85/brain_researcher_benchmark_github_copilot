...
print("Starting analysis for WORK-006: Run developmental trajectory workflow: age prediction model training and evaluation")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Run developmental trajectory workflow: age prediction model training and evaluation")
