...
print("Starting analysis for WORK-007: Execute diffusion pipeline: preprocessing, tractography, structural connectome")
print("=" * 60)
...
try:
    ...
    print(f"Task: Execute diffusion pipeline: preprocessing, tractography, structural connectome")
