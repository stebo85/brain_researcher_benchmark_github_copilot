...
print("Starting analysis for WORK-009: Execute surface-based workflow: FreeSurfer recon, thickness extraction, group statistics")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Execute surface-based workflow: FreeSurfer recon, thickness extraction, group statistics")
