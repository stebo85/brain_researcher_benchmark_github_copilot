...
print("Starting analysis for CONN-013")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Extract connectome fingerprints for individual identification from HCP data
...
# - Expected evidence: fingerprint_vectors.npy

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: CONN-013")
print(f"  - User Prompt: Extract connectome fingerprints for individual identification from HCP data")
print(f"  - Context: Use unique connectivity patterns as a brain fingerprint to identify individuals across scanning sessions")
print(f"  - Data Key: nilearn.datasets.fetch_megatrawls_netmats")
print(f"  - Evidence Required: fingerprint_vectors.npy, identification_matrix.csv")
