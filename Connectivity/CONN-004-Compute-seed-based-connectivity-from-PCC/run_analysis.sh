...
print("Starting analysis for CONN-004")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Compute seed-based connectivity from PCC to whole brain on development data
# - Context: Pick the posterior cingulate (default mode hub) and find everywhere in the brain that synchronizes with it
# - Data: 
# - Expected evidence: pcc_connectivity_map.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: CONN-004")
print(f"  - User Prompt: Compute seed-based connectivity from PCC to whole brain on development data")
print(f"  - Context: Pick the posterior cingulate (default mode hub) and find everywhere in the brain that synchronizes with it")
print(f"  - Data Key: ")
print(f"  - Evidence Required: pcc_connectivity_map.nii.gz, peak_coordinates.csv")
