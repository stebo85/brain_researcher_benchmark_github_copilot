# Detailed Implementation Plan: CONN-008: Calculate inter-subject correlation during movie watching in development dataset
...
**Objective:** Calculate inter-subject correlation during movie watching in development dataset
...
**Required Capabilities:** connectivity_tool; isc_analysis
...
1. **Check output files exist**
   ```bash
   ls -lh isc_map.nii.gz
   ls -lh isc_timecourse.csv
   ```
...
3. **Confirm acceptance metrics are satisfied**
   - Verify: isc_timecourse_generated
   - Verify: peak_isc>0.3
