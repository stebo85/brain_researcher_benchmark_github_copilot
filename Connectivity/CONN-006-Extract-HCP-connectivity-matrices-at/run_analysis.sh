...
print("Starting analysis for CONN-006")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Extract HCP connectivity matrices at 200-parcel resolution for age prediction
...
# - Expected evidence: connectivity_matrices.h5

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: CONN-006")
print(f"  - User Prompt: Extract HCP connectivity matrices at 200-parcel resolution for age prediction")
print(f"  - Context: Get connectivity data from 461 subjects using 200 brain regions to train age prediction models")
print(f"  - Data Key: nilearn.datasets.fetch_megatrawls_netmats")
print(f"  - Evidence Required: connectivity_matrices.h5, subject_metadata.csv")
