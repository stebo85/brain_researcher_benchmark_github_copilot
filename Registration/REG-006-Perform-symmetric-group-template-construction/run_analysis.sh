...
print("Starting analysis for REG-006: Perform symmetric group template construction from ABIDE controls")
print("=" * 60)
...
try:
    ...
    print(f"Task: Perform symmetric group template construction from ABIDE controls")
