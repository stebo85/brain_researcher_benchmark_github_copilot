...
print("Starting analysis for REG-018: Apply temporal registration to align cardiac phase across SPM auditory volumes")
print("=" * 60)
...
try:
    ...
    print(f"Task: Apply temporal registration to align cardiac phase across SPM auditory volumes")
