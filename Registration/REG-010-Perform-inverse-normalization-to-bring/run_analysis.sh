...
print("Starting analysis for REG-010: Perform inverse normalization to bring MNI results back to native space for Miyawaki")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Perform inverse normalization to bring MNI results back to native space for Miyawaki")
