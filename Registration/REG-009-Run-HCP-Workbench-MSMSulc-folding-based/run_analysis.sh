...
print("Starting analysis for REG-009: Run HCP Workbench MSMSulc folding-based surface registration")
print("=" * 60)
...
try:
    ...
    print(f"Task: Run HCP Workbench MSMSulc folding-based surface registration")
