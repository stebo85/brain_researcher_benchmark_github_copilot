...
print("Starting analysis for REG-014")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Perform cross-modality registration of PET to MRI for clinical data
# - Context: Align functional PET images to structural MRI using intensity-based methods
# - Data: 
# - Expected evidence: coregistered_pet.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: REG-014")
print(f"  - User Prompt: Perform cross-modality registration of PET to MRI for clinical data")
print(f"  - Context: Align functional PET images to structural MRI using intensity-based methods")
print(f"  - Data Key: ")
print(f"  - Evidence Required: coregistered_pet.nii.gz, transformation.mat")
