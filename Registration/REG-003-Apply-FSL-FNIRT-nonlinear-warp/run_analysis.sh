...
print("Starting analysis for REG-003: Apply FSL FNIRT nonlinear warp to OASIS subjects to MNI space")
print("=" * 60)
...
try:
    ...
    print(f"Task: Apply FSL FNIRT nonlinear warp to OASIS subjects to MNI space")
