...
print("Starting analysis for REG-020")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Perform longitudinal registration for NKI subjects with repeated scans
...
# - Expected evidence: longitudinal_template.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: REG-020")
print(f"  - User Prompt: Perform longitudinal registration for NKI subjects with repeated scans")
...
print(f"  - Evidence Required: longitudinal_template.nii.gz, timepoint_warps/")
