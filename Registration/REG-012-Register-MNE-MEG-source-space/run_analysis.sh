...
print("Starting analysis for REG-012: Register MNE MEG source space to individual FreeSurfer surfaces")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Register MNE MEG source space to individual FreeSurfer surfaces")
