...
print("Starting analysis for STAT-020")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Apply PALM accelerated permutation testing on OASIS age effects
...
# - Expected evidence: palm_tstat_fwep.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: STAT-020")
print(f"  - User Prompt: Apply PALM accelerated permutation testing on OASIS age effects")
print(f"  - Context: Run fast permutation inference preserving exchangeability blocks for complex designs")
print(f"  - Data Key: nilearn.datasets.fetch_oasis_vbm")
print(f"  - Evidence Required: palm_tstat_fwep.nii.gz, palm_log.txt")
