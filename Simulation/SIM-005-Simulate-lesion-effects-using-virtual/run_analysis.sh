...
print("Starting analysis for SIM-005: Simulate lesion effects using virtual brain lesioning")
print("=" * 60)
...
try:
    ...
    print(f"Task: Simulate lesion effects using virtual brain lesioning")
