...
print("Starting analysis for SIM-018: Generate synthetic tractography with known connectivity matrix")
print("=" * 60)
...
try:
    ...
    print(f"Task: Generate synthetic tractography with known connectivity matrix")
