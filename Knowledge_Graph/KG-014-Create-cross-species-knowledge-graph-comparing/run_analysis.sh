...
print("Starting analysis for KG-014")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Create cross-species knowledge graph comparing human and animal atlases
# - Context: Show corresponding brain regions across species for translational research
# - Data: 
# - Expected evidence: comparative_kg.json

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: KG-014")
print(f"  - User Prompt: Create cross-species knowledge graph comparing human and animal atlases")
print(f"  - Context: Show corresponding brain regions across species for translational research")
print(f"  - Data Key: ")
print(f"  - Evidence Required: comparative_kg.json, species_alignment.png")
