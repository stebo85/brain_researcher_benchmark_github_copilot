...
print("Starting analysis for KG-017: Build multi-resolution parcellation knowledge graph showing nested hierarchies")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Build multi-resolution parcellation knowledge graph showing nested hierarchies")
