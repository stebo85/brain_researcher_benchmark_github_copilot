...
print("Starting analysis for KG-007: Link Harvard-Oxford regions to disease associations from literature")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Link Harvard-Oxford regions to disease associations from literature")
