...
print("Starting analysis for KG-003: Create multi-modal knowledge graph linking ABIDE phenotypes to brain networks")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Create multi-modal knowledge graph linking ABIDE phenotypes to brain networks")
