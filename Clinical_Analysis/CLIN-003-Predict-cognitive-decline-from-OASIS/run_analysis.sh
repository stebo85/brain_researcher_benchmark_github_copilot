...
print("Starting analysis for CLIN-003: Predict cognitive decline from OASIS brain volumes using ML")
print("=" * 60)
...
try:
    ...
    ax.set_title('CLIN-003 - feature_importance.png')
    ax.legend()
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(evidence_dir / 'feature_importance.png', dpi=100, bbox_inches='tight')
    plt.close()
    print(f'✓ Generated feature_importance.png')
