...
print("Starting analysis for CLIN-001")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Classify ADHD vs controls using resting-state connectivity features
...
# - Expected evidence: roc_curve.png

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: CLIN-001")
print(f"  - User Prompt: Classify ADHD vs controls using resting-state connectivity features")
print(f"  - Context: Build diagnostic classifier from brain network patterns to aid clinical assessment")
print(f"  - Data Key: nilearn.datasets.fetch_adhd")
print(f"  - Evidence Required: roc_curve.png, confusion_matrix.png, feature_importance.csv")
