...
print("Starting analysis for CLIN-010")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Perform QSM analysis to measure brain iron in basal ganglia
# - Context: Quantify magnetic susceptibility to assess iron accumulation in Parkinson's
# - Data: 
# - Expected evidence: qsm_map.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: CLIN-010")
print(f"  - User Prompt: Perform QSM analysis to measure brain iron in basal ganglia")
print(f"  - Context: Quantify magnetic susceptibility to assess iron accumulation in Parkinson's")
print(f"  - Data Key: ")
print(f"  - Evidence Required: qsm_map.nii.gz, iron_measurements.csv")
