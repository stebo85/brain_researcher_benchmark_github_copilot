...
print("Starting analysis for QC-018: Compute stability metrics for NKI test-retest subjects")
print("=" * 60)
...
try:
    ...
    print(f"Task: Compute stability metrics for NKI test-retest subjects")
