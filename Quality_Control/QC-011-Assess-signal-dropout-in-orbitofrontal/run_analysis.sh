...
print("Starting analysis for QC-011: Assess signal dropout in orbitofrontal cortex for FIAC data")
print("=" * 60)
...
try:
    ...
    print(f"Task: Assess signal dropout in orbitofrontal cortex for FIAC data")
