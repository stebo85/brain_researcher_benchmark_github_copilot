# Detailed Implementation Plan: QC-006: Assess coregistration quality between functional and anatomical in NKI
...
**Objective:** Assess coregistration quality between functional and anatomical in NKI
...
**Required Capabilities:** coreg_qc_tool; alignment_checker
...
- [ ] alignment_quality_scored
- [ ] dice>0.85

## Required Evidence Files

- [ ] `coregistration_qa.png`
...
1. **Check output files exist**
   ```bash
   ls -lh coregistration_qa.png
   ls -lh alignment_metrics.csv
   ```
...
3. **Confirm acceptance metrics are satisfied**
   - Verify: alignment_quality_scored
   - Verify: dice>0.85
