...
try:
    ...
    # Generate searchlight_slices.png
    ...
    ax.set_title('VIZ-006 - searchlight_slices.png')
    ax.legend()
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(evidence_dir / 'searchlight_slices.png', dpi=100, bbox_inches='tight')
    plt.close()
    print(f'✓ Generated searchlight_slices.png')
