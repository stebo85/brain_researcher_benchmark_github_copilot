...
print("Starting analysis for DIFF-008")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Extract tract profiles along major white matter pathways (CST, arcuate)
# - Context: Sample diffusion metrics along the length of specific tracts to detect localized abnormalities
# - Data: 
# - Expected evidence: cst_fa_profile.csv

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: DIFF-008")
print(f"  - User Prompt: Extract tract profiles along major white matter pathways (CST, arcuate)")
print(f"  - Context: Sample diffusion metrics along the length of specific tracts to detect localized abnormalities")
print(f"  - Data Key: ")
print(f"  - Evidence Required: cst_fa_profile.csv, arcuate_md_profile.csv")
