...
print("Starting analysis for DIFF-009: Compute free water elimination to separate tissue from CSF contamination")
print("=" * 60)
...
try:
    ...
    print(f"Task: Compute free water elimination to separate tissue from CSF contamination")
