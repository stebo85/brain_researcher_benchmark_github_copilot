...
print("Starting analysis for DIFF-005: Compute structural connectome using AAL atlas parcellation")
print("=" * 60)
...
try:
    ...
    print(f"Task: Compute structural connectome using AAL atlas parcellation")
