...
print("Starting analysis for STATINF-004")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run Bayesian second-level analysis with informative priors
...
print("\nTask Requirements:")
print(f"  - Task ID: STATINF-004")
print(f"  - User Prompt: Run Bayesian second-level analysis with informative priors")
print(f"  - Context: Use Bayesian statistics to incorporate prior knowledge and quantify uncertainty")
print(f"  - Data Key: ")
print(f"  - Evidence Required: posterior_mean.nii.gz, credible_intervals.nii.gz")
