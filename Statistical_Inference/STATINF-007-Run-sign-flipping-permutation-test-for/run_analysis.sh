...
print("Starting analysis for STATINF-007")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Run sign-flipping permutation test for paired t-test
# - Context: Test within-subject changes using sign-flipping instead of full permutation
# - Data: 
# - Expected evidence: sign_flip_results.csv

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: STATINF-007")
print(f"  - User Prompt: Run sign-flipping permutation test for paired t-test")
print(f"  - Context: Test within-subject changes using sign-flipping instead of full permutation")
print(f"  - Data Key: ")
print(f"  - Evidence Required: sign_flip_results.csv, null_distribution.png")
