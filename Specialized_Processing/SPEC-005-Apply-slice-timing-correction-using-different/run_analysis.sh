...
print("Starting analysis for SPEC-005: Apply slice-timing correction using different interpolation methods")
print("=" * 60)
...
try:
    ...
    print(f"Task: Apply slice-timing correction using different interpolation methods")
