...
print("Starting analysis for SPEC-004: Run anatomical CompCor to extract physiological noise from Localizer data")
print("=" * 60)
...
try:
    ...
    print(f"Task: Run anatomical CompCor to extract physiological noise from Localizer data")
