...
print("Starting analysis for SPEC-013")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Apply gradient unwarping to correct for gradient nonlinearity
...
print("\nTask Requirements:")
print(f"  - Task ID: SPEC-013")
print(f"  - User Prompt: Apply gradient unwarping to correct for gradient nonlinearity")
print(f"  - Context: Correct geometric distortions from gradient coil imperfections")
print(f"  - Data Key: ")
print(f"  - Evidence Required: unwarped_bold.nii.gz, gradient_coefficients.txt")
