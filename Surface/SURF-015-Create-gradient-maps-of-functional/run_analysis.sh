...
print("Starting analysis for SURF-015")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Create gradient maps of functional connectivity on cortical surface
# - Context: Map smooth gradients in connectivity patterns across cortex to reveal organizational axes
# - Data: 
# - Expected evidence: gradient1.gii

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SURF-015")
print(f"  - User Prompt: Create gradient maps of functional connectivity on cortical surface")
print(f"  - Context: Map smooth gradients in connectivity patterns across cortex to reveal organizational axes")
print(f"  - Data Key: ")
print(f"  - Evidence Required: gradient1.gii, gradient2.gii, gradient_plot.png")
