...
print("Starting analysis for SURF-016")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Compute surface area expansion/contraction from longitudinal scans
# - Context: Measure local changes in cortical surface area over time to detect atrophy or growth
# - Data: 
# - Expected evidence: lh_area_change.gii

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SURF-016")
print(f"  - User Prompt: Compute surface area expansion/contraction from longitudinal scans")
print(f"  - Context: Measure local changes in cortical surface area over time to detect atrophy or growth")
print(f"  - Data Key: ")
print(f"  - Evidence Required: lh_area_change.gii, longitudinal_stats.csv")
