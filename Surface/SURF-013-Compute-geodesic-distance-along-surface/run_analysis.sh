...
print("Starting analysis for SURF-013")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Compute geodesic distance along surface between ROIs
# - Context: Measure distances following cortical surface curvature instead of straight-line Euclidean
# - Data: 
# - Expected evidence: geodesic_distances.csv

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SURF-013")
print(f"  - User Prompt: Compute geodesic distance along surface between ROIs")
print(f"  - Context: Measure distances following cortical surface curvature instead of straight-line Euclidean")
print(f"  - Data Key: ")
print(f"  - Evidence Required: geodesic_distances.csv, shortest_paths.json")
