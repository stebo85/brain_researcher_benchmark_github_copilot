...
print("Starting analysis for SURF-020")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Compute local gyrification index to measure cortical folding complexity
# - Context: Quantify how folded the cortex is by comparing surface area to outer hull area
# - Data: 
# - Expected evidence: lh.pial_lgi

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: SURF-020")
print(f"  - User Prompt: Compute local gyrification index to measure cortical folding complexity")
print(f"  - Context: Quantify how folded the cortex is by comparing surface area to outer hull area")
print(f"  - Data Key: ")
print(f"  - Evidence Required: lh.pial_lgi, lgi_stats.csv, lgi_map.png")
