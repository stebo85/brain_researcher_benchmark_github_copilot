...
print("Starting analysis for SURF-006: Compute curvature, sulcal depth, and surface area for morphometry analysis")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Compute curvature, sulcal depth, and surface area for morphometry analysis")
