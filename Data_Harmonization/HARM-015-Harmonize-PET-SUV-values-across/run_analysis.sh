...
print("Starting analysis for HARM-015")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Harmonize PET SUV values across scanners using phantom calibration
# - Context: Use phantom scans to calibrate and harmonize SUV quantification
# - Data: 
# - Expected evidence: harmonized_suv.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: HARM-015")
print(f"  - User Prompt: Harmonize PET SUV values across scanners using phantom calibration")
print(f"  - Context: Use phantom scans to calibrate and harmonize SUV quantification")
print(f"  - Data Key: ")
print(f"  - Evidence Required: harmonized_suv.nii.gz, calibration_curves.png")
