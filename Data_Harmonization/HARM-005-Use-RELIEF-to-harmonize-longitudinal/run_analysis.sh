...
print("Starting analysis for HARM-005: Use RELIEF to harmonize longitudinal data accounting for age effects")
print("=" * 60)
...
Step 2: Running analysis...")
    print(f"Task: Use RELIEF to harmonize longitudinal data accounting for age effects")
