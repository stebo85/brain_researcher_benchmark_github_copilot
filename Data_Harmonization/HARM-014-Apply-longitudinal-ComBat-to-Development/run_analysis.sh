...
print("Starting analysis for HARM-014: Apply longitudinal ComBat to Development fMRI repeated measures")
print("=" * 60)
...
try:
    ...
    print(f"Task: Apply longitudinal ComBat to Development fMRI repeated measures")
