...
print("Starting analysis for HARM-011")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Harmonize diffusion metrics across QSIPrep pipeline versions
# - Context: Account for preprocessing pipeline differences in longitudinal data
# - Data: 
# - Expected evidence: harmonized_fa.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: HARM-011")
print(f"  - User Prompt: Harmonize diffusion metrics across QSIPrep pipeline versions")
print(f"  - Context: Account for preprocessing pipeline differences in longitudinal data")
print(f"  - Data Key: ")
print(f"  - Evidence Required: harmonized_fa.nii.gz, pipeline_comparison.csv")
