...
print("Starting analysis for HARM-010")
print("=" * 60)

# TODO: Implement the actual analysis based on:
# - Task: Apply RAVEL intensity normalization to Brainomics Localizer T-maps
...
# - Expected evidence: normalized_tmaps.nii.gz

# Placeholder implementation - this should be customized per task
print("\nNOTE: This is a template script.")
print("The actual analysis implementation needs to be added based on the task requirements.")
print("\nTask Requirements:")
print(f"  - Task ID: HARM-010")
print(f"  - User Prompt: Apply RAVEL intensity normalization to Brainomics Localizer T-maps")
...
print(f"  - Evidence Required: normalized_tmaps.nii.gz, normalization_qc.csv")
